...
const SearchBarMobile = ({ hideNav }) => (
  <div
    className={`fixed top-0 left-0 right-0 z-40 px-4 py-3 bg-black/60 backdrop-blur-md border-b border-white/10 transition-transform duration-500 ease-in-out ${hideNav ? 'translate-y-[-100%]' : 'translate-y-0'} md:hidden`}
  >
