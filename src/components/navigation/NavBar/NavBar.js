...
const NavBar = () => {
  ...
  return (
    <>
      ...
      {activeTab === 'explore' && <SearchBar hideNav={hideNav} />}
      ...
      {showModal && (
        ...
        >
          <div
            className="w-full max-w-sm bg-black/30 backdrop-blur-md rounded-2xl text-white p-6 relative shadow-2xl"
          ...
          >
            ...
            <p className="text-sm text-white/70 mb-6">
              Log in to start planning your next vacation.
            </p>
